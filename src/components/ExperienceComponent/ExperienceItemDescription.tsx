...
import LongDataComponent from "./Longdata";

const ExperienceItemDescriptionComponent = ( { isExpanded, experienceItem  } : ExperienceItemDescriptionProps ):React.ReactNode => {

    const {stack, tasks, short_description } : { stack: Stack[], tasks: Task[], short_description: string } = experienceItem;
